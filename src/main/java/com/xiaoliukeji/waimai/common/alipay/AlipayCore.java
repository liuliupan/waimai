...
public class AlipayCore {
	...
	public static String partner = "2088021119469553";
	/** 商户的私钥key */
	public static String key = "6x7f5gin1grq6wvpfwji07m7rtqtx6ey";
	/** 收款支付宝账号 */
	public static String seller_email = "2355908671@qq.com";
	/** ################ 根据不同公司需要更改 (三个属性) ###################### */
